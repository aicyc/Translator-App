...
abstract class $LanguageModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String isoCode, String countryName});
}
...
class _$LanguageModelImpl implements _LanguageModel {
  const _$LanguageModelImpl({this.isoCode = '', this.countryName = ''});
  ...
  @override
  String toString() {
    return 'LanguageModel(isoCode: $isoCode, countryName: $countryName)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, isoCode, countryName);
...
abstract class _LanguageModel implements LanguageModel {
  const factory _LanguageModel(
      {final String isoCode, final String countryName}) = _$LanguageModelImpl;
